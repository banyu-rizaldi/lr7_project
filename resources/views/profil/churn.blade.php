        ...
        <div class="card">
            <div class="card-body">
                <script type='text/javascript' src='https://smartanalytics0.telkom.co.id/javascripts/api/viz_v1.js'></script>
                    <div class='tableauPlaceholder' style='width: 100px; height: 700px;'>
                        <object class='tableauViz' width='100%' height='700' style='display:none;'>
                            ...
                            <param name='embed_code_version' value='3' /> <param name='site_root' value='&#47;t&#47;TelkomRegionalAnalytics' />
                            <param name='name' value='DistribusiChurntoSales&#47;Dashboard1' /><param name='tabs' value='no' />
