...
Route::group(['middleware' => 'login'], function() {
    ...
    Route::get('logout', 'otentikasi\OtentikasiController@logout')->name('logout');
     ...
     // sales
    Route::get('sales/index', 'SalesController@index')->name('sales');
    ...
    // akhir sales
     ...
     Route::get('alert/detil/{NOTEL}', 'ReportController@alert');
     Route::get('alert/detil/{NOTEL}', 'ReportController@view')->name('alert2');
    ...
    Route::get('leveraging', 'ProfilController@leveraging')->name('leveraging');
    Route::get('retention', 'ProfilController@retention')->name('retention');
    Route::get('kw', 'ProfilController@kw')->name('kw');
